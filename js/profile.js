...
function togglePasswordVisibility2() {
    ...
    const eyeIcon = document.querySelector('.password-toggle-icon2 i');
...
function togglePasswordVisibility3() {
    ...
    const eyeIcon = document.querySelector('.password-toggle-icon3 i');
...
function togglePasswordVisibility4() {
    const passwordInput = document.getElementById('existing-pw');
    const eyeIcon = document.querySelector('.password-toggle-icon4 i');
